  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        {/* Search bar placeholder - can be implemented fully later with client component */}
        <div className="relative">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
          <Input
            placeholder="Search topics..."
            className="pl-10 max-w-md"
            // This would need to be a client component trigger or URL param search
            disabled
          />
        </div>
              ...
              >
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <Badge
                      variant={topic.difficulty as "easy" | "medium" | "hard"}
                    >
                      {topic.difficulty}
                    </Badge>
